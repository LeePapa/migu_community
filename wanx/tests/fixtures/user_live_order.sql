...
--
-- Table structure for table `user_live_order`
--

DROP TABLE IF EXISTS `user_live_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_live_order` (
...
--
-- Dumping data for table `user_live_order`
--

LOCK TABLES `user_live_order` WRITE;
/*!40000 ALTER TABLE `user_live_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_live_order` ENABLE KEYS */;
UNLOCK TABLES;
