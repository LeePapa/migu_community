...
from wanx.models.activity import Team
...
def upload_small_file():
    ...
    if _type not in {"videos.cover", "videos.url", "users.logo", "users.photo", "teams.logo",
                     "user_certify.ID_photo", "user_certify.ID_photo_2"}:
